const home = {
  ...
  productSorrentinosDesc: 'Elaborados artesanalmente con rellenos abundantes y masa tierna. Probá nuestras variedades de jamón y queso, verdura y ricota.',
  productRaviolesTitle: 'Ravioles',
  productRaviolesDesc: 'La receta de la abuela en tu mesa. Ravioles y rabioles tradicionales de carne, verdura o pollo, listos para hervir y disfrutar en familia.',
  productFideosTitle: 'Fideos Frescos',
  productFideosDesc: 'Tallarines y cintas al huevo amasados diariamente con sémola de trigo candeal de primera calidad. Textura y sabor inigualables.',
  ...
  whatsappFloatingBadge: '¿Consultas o pedidos? ¡Escribinos!',
  whatsappDefaultMessage: 'Hola Pastas Simón, quisiera hacer una consulta sobre los pedidos de pastas.',
