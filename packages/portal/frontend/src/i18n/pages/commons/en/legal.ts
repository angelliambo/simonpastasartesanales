export const legal = {
  ...
  seccion3Item2: 'Email Services: For sending notifications and access confirmations.',
  seccion3Item3: 'Database APIs: For secure and persistent storage of your data.',
  seccion3Texto2: 'The User acknowledges that these external services are subject to the privacy terms of their respective providers, and the {{siteName}} Team is not responsible for the operation or practices of third parties.',

  seccion4Titulo: '4. Privacy and Data',
  seccion4Texto1: '{{siteName}} processes and stores data in accordance with modern security standards.',
  seccion4Texto2: 'All information is encrypted in transit and at rest. Financial transactions are never stored on our servers.',
  ...
  seccion5Item4: 'Loss of data resulting from incorrect configurations or unauthorized access caused by user negligence.',
  ...
  seccion6Texto2: 'The User acquires no ownership rights over the software. Registration only grants a limited, non-exclusive, and revocable license of use.',
  seccion6ListaTitulo: 'The following is prohibited:',
  seccion6Item1: 'Copying, modifying, distributing, or reselling parts of the platform\'s code without authorization.',
  seccion6Item2: 'Decompiling or attempting to reverse engineer the portal software.',
  seccion6Item3: 'Using the service for unlawful purposes or purposes not authorized by these terms.',
  ...
  seoTitle: 'Terms and Conditions - {{siteName}}',
  seoDescription: 'Terms and conditions of use for the {{siteName}} platform. Know the details of our license of use and limitation of liability.',
