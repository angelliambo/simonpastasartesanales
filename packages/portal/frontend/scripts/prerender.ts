...
const routesToPrerender = [
  {
    path: 'precios',
    title: 'Lista de Precios de Sorrentinos, Ravioles & Pastas | Fábrica Simón Bernal',
    description: 'Precios actualizados de sorrentinos de jamón y queso, bondiola, ravioles caseros, ñoquis del 29 y empanadas congeladas en caja. Venta minorista y promociones mayoristas en Bernal, Quilmes y Zona Sur.',
    canonical: 'https://simonpastasartesanales.com.ar/precios',
    ogTitle: 'Lista de Precios Oficial - Fábrica de Pastas Simón',
    ogDescription: 'Precios de sorrentinos artesanales en caja, ravioles y venta mayorista en Bernal y Zona Sur.',
  ...
  {
    path: 'productos',
    title: 'Catálogo de Sorrentinos, Ravioles, Ñoquis & Pastas en Caja | Fábrica Simón',
    description: 'Descubre nuestra variedad de pastas artesanales congeladas en caja: sorrentinos de jamón y queso, bondiola braseada, ravioles de espinaca, ñoquis del 29 y empanadas.',
  ...
  {
    path: 'mayorista',
    title: 'Venta Mayorista de Pastas para Restaurantes & Catering | Fábrica Simón',
    description: 'Distribución mayorista directa de pastas congeladas en caja para restaurantes, cantinas, rotiserías y catering en Quilmes, Bernal, Avellaneda y Zona Sur.',
