export const emails = {
  ticket: {
    ...
    message: "Message",
    userNumber: "User N°",
    reply: "A support agent from <strong>ZenithNexus</strong> has replied to your support ticket <strong>{{ticketId}}</strong>.",
  ...
  wellcome: {
    title: "Wellcome to <strong>ZenithNexus</strong>!",
    ...
    download: "Download the extension from the <a href=\"https://chromewebstore.google.com\" style=\"color:#818cf8;\">Chrome Web Store</a> and start using ZenithNexus instantly.",
  },
  subject: {
    ...
    wellcome: "Wellcome to ZenithNexus!",
