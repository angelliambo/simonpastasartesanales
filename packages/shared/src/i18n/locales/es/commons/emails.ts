export const emails = {
  ticket: {
    ...
    reply: "Un agente de soporte de <strong>ZenithNexus</strong> ha respondido a tu ticket de soporte <strong>{{ticketId}}</strong>.",
  ...
  wellcome: {
    title: "¡Bienvenido a <strong>ZenithNexus</strong>!",
    ...
    download: "Descargá la extensión desde <a href=\"https://chromewebstore.google.com\" style=\"color:#818cf8;\">Chrome Web Store</a> y empezá a usar ZenithNexus al instante.",
  },
  subject: {
