...
const NotificationItemComponent: React.FC<{
  ...
  const accessibility = {
    largeText: (personalizationData.accessibility.fontSizeMultiplier || 1) > 1,
    increasedSpacing: personalizationData.accessibility.increasedSpacing || false,
    highContrast: personalizationData.accessibility.highContrast || false,
    reducedMotion: personalizationData.accessibility.reduceMotion || false,
  };
